...
public:
    ...
    virtual void setBitsPerSample(int _bitsPerSample){};

    void setSelectedChannel(int _selectedChannel) {
...
protected:
    ...
    void setSampleRateAndChannelCount(float _sampleRate, int _channelCount) {
