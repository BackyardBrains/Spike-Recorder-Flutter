...
define(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      t1.$indexSet(0, "multiplicationz", A.multiply___multiply$closure());
      return 5567;
    }
  },
  J = {
  ...
  (function installTearOffs() {
    ...
    _static_2(A, "multiply___multiply$closure", "_multiply", 11);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["@(@)", "~(String,@)", "@(@,String)", "@(String)", "~(Object?,Object?)", "~(Symbol0,@)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Object?(@)", "int(int,int)", "double(double,double)"],
