...
define(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      A.print(5567000000);
      var t1 = $.$get$_context();
      t1.$indexSet(0, "myHyperSuperMegaFunction", A.webplugin___add$closure());
      A.print(t1);
      return 5567;
    }
  },
  ...
  (function installTearOffs() {
    ...
    _static_2(A, "webplugin___add$closure", "_add", 10);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["@(@)", "~(String,@)", "@(@,String)", "@(String)", "~(Object?,Object?)", "~(Symbol0,@)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Object?(@)", "int(int,int)"],
