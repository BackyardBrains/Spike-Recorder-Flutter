...
List<DropdownMenuItem<int>> getColorDropDown(){
  ...
  List<Color> colors = [ Color(0xFF1ed400), Color(0xFFff0035),Color(0xFFffff00), Color(0xFF20b4aa), Color(0xFFdcdcdc),Color(0xFFff3800),]  ;
  int idx = 0;
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    const Text("Enable Legacy USB - Neuron Pro, Muscle Pro (Pre-2023) "),
                    Checkbox(
