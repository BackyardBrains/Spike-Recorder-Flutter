...
// END COPY ME    
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    envelopingSamples(_head, sample, _envelopes, SIZE_LOGS2, skipCounts) {
      var t1, t2, j, skipCount, interleavedSignalIdx, t3;
      A._asInt(_head);
      A._asDouble(sample);
      A._asInt(SIZE_LOGS2);
      type$.List_int._as(skipCounts);
      for (t1 = J.getInterceptor$asx(_envelopes), t2 = J.getInterceptor$asx(skipCounts), j = 0; j < SIZE_LOGS2; ++j) {
        skipCount = t2.$index(skipCounts, j);
        ...
        if (B.JSInt_methods.$mod(_head, skipCount) === 0) {
          ...
          if (sample < A._asNum(J.$index$asx(t1.$index(_envelopes, j), interleavedSignalIdx)))
            J.$indexSet$ax(t1.$index(_envelopes, j), interleavedSignalIdx, sample);
          t3 = interleavedSignalIdx + 1;
          if (sample > A._asNum(J.$index$asx(t1.$index(_envelopes, j), t3)))
            J.$indexSet$ax(t1.$index(_envelopes, j), t3, sample);
        }
      }
    }
  },
  ...
  (function installTearOffs() {
    ...
    _static_2(A, "multiply___add$closure", "_add", 10);
    _static_2(A, "multiply__multiply$closure", "multiply", 11);
    _static(A, "multiply__envelopingSamples$closure", 5, null, ["call$5"], ["envelopingSamples"], 12, 0);
  })();
